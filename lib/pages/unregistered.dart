...
/*
  ...
  List<Map<String, dynamic>> get_commodity_dropdown_values(List commodity) {
    ...
    for (String com in commodity) {
      if(com.toString() != "") {
        Map<String, dynamic> myObject = {
          'display' : com.toString(),
          //'value':  _commodityid[i].toString()

          'value': Text(_commodityid[i].toString(),softWrap: true,)
        };
        items.add(myObject);
        i++;
      }
  ...
  * When page loads for first time
  ...
  Future updateCommodityDropdown(String newQuery) async {
    ...
    setState(() {
      ...
      send = get_commodity_dropdown_values(_commodityname);
      print("=========111111111111111111111111111=======================");
      print(get_commodity_dropdown_values(_commodityname));
    });
